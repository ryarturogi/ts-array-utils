...
export declare function isSorted(data: any, compareFn: (a: any, b: any) => number, direction?: 'asc' | 'desc', findByKey?: string): boolean;
...
export declare function remove(data: any[], index: number | ((x: number) => boolean), count?: number): any[];
